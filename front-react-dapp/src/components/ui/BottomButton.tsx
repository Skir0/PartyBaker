    ...
    return (
        <footer className="fixed bottom-0 w-full bg-surface-bright p-4 safe-bottom z-50">
            <button
                onClick={onClick}
                disabled={disabled}
                className="w-full bg-[#2481CC] text-white font-semibold py-4 rounded-xl shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
            >
                <span>{text}</span>
